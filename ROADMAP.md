...
- 2026-09-06 Phase 0.5 preparation: the verified hosted baseline, browser-signup removal, and a proposed forward-only security migration are prepared for review. The migration is unapplied; the pending Auth Dashboard changes and anonymous/authenticated verification must complete before Phase 0.5 can be marked done.
