...
- [ ] Perform the documented authenticated manual verification with a non-production test record; record the exact result. Automated regressions belong in Phase 1.
